...
-u "<oracle_support_id>" "ftps://transport.oracle.com/issue/<sr_number>/"
...
curl -s --url 'smtp://172.19.8.192:587' --mail-from '<from_address>' --mail-rcpt '<recipients>' --upload-file ma
il.txt -n
