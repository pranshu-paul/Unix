...
curl -L <the_url> --output <any_file_name># -- To download a file.
...
host -t ptr 8.8.8.8 # -- Reverse DNS lookup.
...
postsuper -d <message_id> # To delete a specific mail from mail queue.

postsuper -d ALL # To delete all the messages.

# -- SYSTEM AND PROCESS MANAGEMENT -- #
nproc # Lists number of cores available.
...
{ echo $APPS_USER; echo $APPS_PASS; echo $WEBLOGIC_PASS; } | sh adstpall.sh -nopromptmsg