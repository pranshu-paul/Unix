...
export_array=('/nfs-share') # Array of local filesystems to be exported
remote_array=('0.0.0.0/0(sync,rw,insecure,no_root_squash)') # Array of remote client/mount option groupings for a given export
